#!/bin/bash
set -eo pipefail
readonly SCRIPT="docker run -it shitiomatic/forkbacon:latest"
...
git remote set-url origin https://x-access-token:$GITHUB_TOKEN@github.com/open-sauced/open-sauced.git
echo "### Getting branch"
